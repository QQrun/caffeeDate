...
class ProfilePopoverPresentationController: UIPresentationController {
...
private extension ProfilePopoverPresentationController {
    func setupDimmingView() {
        ...
        if let popoverVC = presentedViewController as? ProfilePopoverViewController {
